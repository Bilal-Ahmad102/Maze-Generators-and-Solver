...
class Cell:
    def __init__(self, x, y):
        ...
        self.visited = False
        self.id = f"{x},{y}"  # Unique identifier for each cell
    
    def __lt__(self, other):
        return self.id < other.id  # This allows cells to be compared    
    ...
    def show(self, w, cell_batch, lines_batch, last_y,wall_color):
        ...
        y2 = y2 - 5 if self.y == last_y else y2     # Last row, most top line
